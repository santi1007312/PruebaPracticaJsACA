...
| :--- | :--- | :--- |
| [Santiago Carrillo] | Líder (Arquitecto) | `@usuario1` |
| [Eileen Mendoza] | Desarrollador | `@usuario2` |
| [Juan David Ramirez] | Desarrollador | `@usuario3` |
...
* **Reuniones de Sincronización (Daily Stand-up):** Nos reuniremos los días [26/03/2026] a las [1:00 p.m] de forma [Presencial].
* **Tiempo máximo de respuesta:** Nos comprometemos a responder mensajes del equipo en un máximo de [30 minutos] durante el horario hábil.

## 4. Reglas de Desarrollo
* **Prohibido el "Push" a Main:** Nadie, bajo ninguna circunstancia, subirá código directamente a `main` o `developer` sin pasar por un Pull Request.
